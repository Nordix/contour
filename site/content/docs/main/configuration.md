...
| max-request-headers-kb            | int    | 60      | Defines the maximum request headers size in KiB for incoming connections. If not set, the Envoy default of 60 KiB is used. Valid range: 1-8192. |
